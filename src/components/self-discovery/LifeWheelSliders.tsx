          ...
          <div key={area.area_name} className="space-y-3">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                ...
                <div className="relative">
                  ...
                  {showingValue?.area === area.area_name && showingValue.type === 'desired' && (
                    <div className="absolute -top-8 left-1/2 transform -translate-x-1/2 bg-secondary text-secondary-foreground px-2 py-1 rounded text-xs animate-fade-in">
                      {area.desired_score}
                    </div>
                  )}
                </div>
              ...
              <Slider
                ...
                min={1}
                step={1}
                className="w-full [&>span:first-child]:bg-secondary [&>span:first-child>span]:bg-secondary [&>span:last-child]:border-secondary [&>span:last-child]:bg-background"
                disabled={saving}
              />
            </div>
          </div>
